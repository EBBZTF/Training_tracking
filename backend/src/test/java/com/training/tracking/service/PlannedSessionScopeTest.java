...
/**
 * The scope query parameter decides whether an edit hits one occurrence or the rest of a series, so
 * an unrecognised value must never quietly fall through to the narrower meaning.
 */
